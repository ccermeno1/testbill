"""Formas de entrada y salida del modelo, y ejecucion en acelerador."""
...
def test_angle_projection_is_fixed(model):
    """La proyeccion DFL del angulo es una constante, no un parametro entrenable."""
...
def test_build_sizes_have_expected_scale():
    ...
    assert 7e6 < small < 9e6          # PP-YOLOE-R-s son ~8.1 M parametros
    assert medium > small
